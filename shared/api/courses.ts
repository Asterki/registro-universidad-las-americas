...
export interface CreateCourseResponseData {
  status: ResponseStatus | "faculty-not-found" | "period-not-found" | "course-code-exists";
  course?: any;
}

export interface UpdateCourseResponseData {
  status: ResponseStatus | "course-not-found" | "faculty-not-found" | "period-not-found" | "course-code-exists";
  course?: any;
}
