...
const handler = async (
  req: Request<{}, {}, AcademicHistoryAPITypes.GetStudentAcademicHistoryRequestBody>,
  ...
  try {
    ...
    LoggingService.log({
      source: "api:academic-history:get-student",
      level: "info",
      message: "Student academic history retrieved",
      traceId: req.traceId,
      duration,
      details: {
        accountId,
    ...
    if (error instanceof Prisma.PrismaClientKnownRequestError) {
      LoggingService.log({
        source: "api:academic-history:get-student",
        level: "error",
        message: "Prisma error during student academic history retrieval",
        traceId: req.traceId,
        details: {
          code: error,
          meta: error,
      ...
      LoggingService.log({
        source: "api:academic-history:get-student",
        level: "error",
        message: "Error during student academic history retrieval",
        traceId: req.traceId,
        details: {
          error: error.message,
          stack: error.stack,
