...
const handler = async (
  ...
  try {
    ...
    LoggingService.log({
      source: "api:grades:instructor:update",
      level: "info",
      message: "Grade updated by instructor successfully",
      traceId: req.traceId,
      duration,
      details: {
        gradeId: grade.id,
    ...
    if (error instanceof Prisma.PrismaClientKnownRequestError) {
      LoggingService.log({
        source: "api:grades:instructor:update",
        level: "error",
        message: "Prisma error during grade update by instructor",
        traceId: req.traceId,
        details: {
          code: error,
          meta: error,
      ...
      LoggingService.log({
        source: "api:grades:instructor:update",
        level: "error",
        message: "Error during grade update by instructor",
        traceId: req.traceId,
        details: {
          error: error.message,
          stack: error.stack,
