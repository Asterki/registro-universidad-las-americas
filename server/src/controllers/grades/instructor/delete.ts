...
const handler = async (
  ...
  try {
    ...
    LoggingService.log({
      source: "api:grades:instructor:delete",
      level: "info",
      message: "Grade deleted by instructor successfully",
      traceId: req.traceId,
      duration,
      details: {
        gradeId: id,
    ...
    if (error instanceof Prisma.PrismaClientKnownRequestError) {
      LoggingService.log({
        source: "api:grades:instructor:delete",
        level: "error",
        message: "Prisma error during grade deletion by instructor",
        traceId: req.traceId,
        details: {
          code: error,
          meta: error,
      ...
      LoggingService.log({
        source: "api:grades:instructor:delete",
        level: "error",
        message: "Error during grade deletion by instructor",
        traceId: req.traceId,
        details: {
          error: error.message,
          stack: error.stack,
