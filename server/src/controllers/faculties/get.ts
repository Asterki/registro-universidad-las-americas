...
const handler = async (
  req: Request<{}, {}, FacultyAPITypes.GetFacultyRequestBody>,
  res: Response<FacultyAPITypes.GetFacultyResponseData>,
  _next: NextFunction,
) => {
  ...
  try {
    ...
    const fieldsToPopulate = populate
      ? getFieldsToPopulate<
        FacultyInclude,
        NonNullable<FacultyAPITypes.GetFacultyRequestBody["populate"]>
      >(populate, {
