...
const handler = async (
  req: Request<{}, {}, FacultiesAPITypes.CreateFacultyRequestBody>,
  res: Response<FacultiesAPITypes.CreateFacultyResponseData>,
  _next: NextFunction,
) => {
  const start = performance.now();
  const { campusId, name, code, dean, coordinatorIds } = req.body;
