...
const handler = async (
  req: Request<{}, {}, RequestsAPITypes.ReviewRequestRequestBody>,
  ...
  try {
    ...
    if (error instanceof Prisma.PrismaClientKnownRequestError) {
      LoggingService.log({
        source: "api:requests:review",
        level: "error",
        message: "Prisma error during request review",
        traceId: req.traceId,
        details: {
          code: error,
          meta: error,
      ...
      LoggingService.log({
        source: "api:requests:review",
        level: "error",
        message: "Error during request review",
        traceId: req.traceId,
        details: {
          error: error.message,
          stack: error.stack,
