...
import { removeInstructorCampusWithRetry, InstructorCampusNotFoundError } from "../../services/account-profiles/campus.js";
...
const handler = async (
  ...
  try {
    ...
    const account = await removeInstructorCampusWithRetry(
      { accountId },
      {
        traceId: req.traceId,
        userAccount,
