const translation = {
  ...
  permissions: {
    ...
    // Campuses
    "campuses.create": "Crear campus",
    "campuses.read": "Leer campus",
    "campuses.update": "Actualizar campus",
    "campuses.delete": "Eliminar campus",
    "campuses.restore": "Restaurar campus",
    campuses: "Campus",
    enrollment: "Inscripciones",
    "enrollment.enroll-self": "Inscribirse a sí mismo",
    "enrollment.enroll-student": "Inscribir a un estudiante",
    "enrollment.cancel-self": "Cancelar inscripción propia",
    "enrollment.cancel-student": "Cancelar inscripción de un estudiante",
    "enrollment.validate": "Validar inscripción",
    "enrollment.list-student": "Listar inscripciones de estudiantes",
    "enrollment.list-course": "Listar inscripciones por curso",
    "enrollment.detail": "Detalles de inscripción",
    "enrollment.complete": "Completar inscripción",
    "enrollment.fail": "Fallar inscripción",
    grades: "Calificaciones",
    "grades.record": "Registrar calificaciones",
    "grades.update": "Actualizar calificaciones",
    "grades.delete": "Eliminar calificaciones",
    "grades.list-student": "Listar calificaciones de estudiantes",
    "grades.list-course": "Listar calificaciones por curso",
    "grades.list-faculty": "Listar calificaciones por facultad",
    "grades.detail": "Detalles de calificaciones",
    "grades.publish-final": "Publicar calificaciones finales",
    "grades.bulk-record": "Registrar calificaciones en lote",
    "academic-history": "Historial Académico",
    "academic-history.get-student":
      "Obtener historial académico de un estudiante",
    "academic-history.transcript": "Obtener transcript académico",
    "academic-history.check-prerequisites": "Verificar requisitos previos",
    requests: "Solicitudes",
    "requests.create-student": "Crear solicitud para un estudiante",
    "requests.list": "Listar solicitudes",
    "requests.detail": "Detalles de solicitud",
    "requests.approve": "Aprobar solicitud",
    "requests.reject": "Rechazar solicitud",
    "requests.review": "Revisar solicitud",
    "requests.resolve": "Resolver solicitud",
    "requests.assign": "Asignar solicitud",
    "requests.add-response": "Agregar respuesta a la solicitud",
    courses: "Cursos",
    "courses:list": "Listar cursos",
    "courses:detail": "Detalles del curso",
    "courses:prerequisites": "Requisitos previos del curso",
    "courses:roster": "Lista de estudiantes del curso",
    "course-instructor": "Instructores de curso",
    "course-instructor:assign": "Asignar instructor a curso",
    "course-instructor:remove": "Eliminar instructor de curso",
    "course-instructor:list": "Listar instructores de curso",
    "course-instructor:activate": "Activar instructor de curso",
    "course-instructor:deactivate": "Desactivar instructor de curso",
    period: "Periodos",
    "period.list": "Listar periodos",
    "period.detail": "Detalles del periodo",
    "account-profiles": "Perfiles de Cuenta",
    "account-profiles.view-student": "Ver perfil de estudiante",
    "account-profiles.view-instructor": "Ver perfil de instructor",
    "account-profiles.assign-campus": "Asignar campus a perfil",
    "account-profiles.remove-campus": "Eliminar campus de perfil",
    "account-profiles.list-faculty": "Listar facultades",
    coordinator: "Coordinador",
    "coordinator.view-scope": "Ver alcance del coordinador",
    "coordinator.list-courses": "Listar cursos",
    "coordinator.list-students": "Listar estudiantes",
    registry: "Registro",
    "registry.list-requests": "Listar solicitudes",
    "registry.process-requests": "Procesar solicitudes",
    "registry.list-instructors": "Listar instructores",
    catalogs: "Catálogos",
    "catalogs.list": "Listar catálogos",
    faculties: "Facultades",
    "faculties.create": "Crear facultad",
    "faculties.read": "Leer facultad",
    "faculties.update": "Actualizar facultad",
    "faculties.delete": "Eliminar facultad",
    "faculties.restore": "Restaurar facultad",
    "courses.create": "Crear curso",
    "courses.update": "Actualizar curso",
    "courses.delete": "Eliminar curso",
    "courses.restore": "Restaurar curso",
    periods: "Periodos",
    "periods.create": "Crear periodo",
    "periods.update": "Actualizar periodo",
    "periods.delete": "Eliminar periodo",
    "periods.restore": "Restaurar periodo",
  },
